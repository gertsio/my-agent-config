...
Use this skill when working inside the `everything-Codex` repository and you need repo-specific guidance instead of generic coding advice.

Optional companion instincts live at `.Codex/homunculus/instincts/inherited/everything-Codex-instincts.yaml` for teams using `continuous-learning-v2`.
